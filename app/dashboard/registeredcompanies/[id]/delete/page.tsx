import { deleteRegisteredCompany } from "@/app/action";
      ...
      <Card className="w-full max-w-md rounded-2xl border shadow-lg p-6">
        ...
        <CardHeader className="text-center space-y-3">
          ...
          <CardDescription className="text-sm text-gray-600">
            ...
            It will permanently delete this registered company and remove all associated data from our servers.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-center gap-4 mt-4">
          ...
          >
            <Link href="/dashboard/registeredcompanies">Cancel</Link>
          </Button>

          <form action={deleteRegisteredCompany}>
            <input
              type="hidden"
